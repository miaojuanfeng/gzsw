...
//            }
            ...
            plan.put("INTV", m.getBigDecimal("intv"));     //有变化
            // 单站预报
            if( show == 2 ){
                m.put("intv", plan.getBigDecimal("T"));         //有变化
            }
            ...
            if( ModelTypeEnum.XAJ_CL.getId().equals(planModelCl) ) {
                if( ModelTypeEnum.XAJ_HL.getId().equals(planModelHl) ){
                    listQTR = XajCalc.getR(plan, listP, xajParam, CommonConst.RETURN_TYPE_QTR);   //有变化
                }else{
            ...
            if( ModelTypeEnum.XAJ_HL.getId().equals(planModelHl) ) {
                if( ModelTypeEnum.XAJ_CL.getId().equals(planModelCl) ){
                    listQTRR = XajCalc.getQTRR(plan, listP, xajParam);      //有变化
                }else{
