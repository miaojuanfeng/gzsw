  ...
  <div class="layui-row layui-col-space15">
    <div class="layui-col-md12">
      <div class="layui-card">
        <div class="layui-card-header">未来雨量方案列表</div>
...
<form class="layui-form" lay-filter="contentBox2" id="contentBox2" style="padding:15px;display: none;">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label"></label>
    <div class="layui-input-block">
      <div><a href="${pageContext.request.contextPath}/assets/excel/rain.xlsx">下载：未来雨量方案文件模板.xlsx</a></div>
    </div>
  </div>
</form>
